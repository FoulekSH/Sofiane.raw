  ...
  return (
    <div className="bg-white text-black min-h-screen font-serif">
      {invoices.map((invoice, index) => {
        ...
        return (
          <div key={invoice.id} className={`p-10 md:p-20 ${index > 0 ? 'break-before-page' : ''}`}>
            {/* Header Facture */}
            <div className="flex justify-between items-start mb-20">
              ...
              <div className="text-right space-y-1 font-sans">
                <h2 className="text-2xl font-bold mb-4 uppercase tracking-widest">{invoice.type === 'QUOTE' ? 'Devis' : 'Facture'}</h2>
            ...
            <div className="mb-20 font-sans">
              ...
              <div className="space-y-1">
                 ...
                 <p className="text-zinc-600 whitespace-pre-line">{invoice.address || invoice.client?.address}</p>
            ...
            <div className="mt-auto pt-20 border-t border-zinc-100 font-sans">
              <div className="grid grid-cols-2 gap-12 text-[10px] text-zinc-400 uppercase tracking-widest leading-relaxed">
                 <div>
